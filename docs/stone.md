...
- Redmi Note 12 5G (`sunstone`) `22111317G` `22111317I` `22101317C`
- POCO X5 5G (`moonstone`) `22111317PG` `22111317PI`

## Downloads
[Get the builds here](stone_downloads.md)

## Guides
- [Installation](stone/install.md)
...
## Find help online
You can find assistance with Custom ROMs on [our Telegram chat](https://t.me/Mayuresh_Releases).
